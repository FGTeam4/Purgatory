...
void APurgatoryCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("LookUp", this, &APurgatoryCharacter::AddControllerPitchInput);
...
void APurgatoryCharacter::AddControllerPitchInput(float Val)
{
	if (Val != 0.0f && Controller && Controller->IsLocalPlayerController())
	{
		Val *= LookSensitivity;
