...
void APurgatoryCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &APurgatoryCharacter::OnResetVR);
...
//void APurgatoryCharacter::TouchUpdate(const ETouchIndex::Type FingerIndex, const FVector Location)
//{
...
bool APurgatoryCharacter::EnableTouchscreenMovement(class UInputComponent* PlayerInputComponent)
{
	if (FPlatformMisc::SupportsTouchInput() || GetDefault<UInputSettings>()->bUseMouseForTouch)
	{
		...
		//PlayerInputComponent->BindTouch(EInputEvent::IE_Repeat, this, &APurgatoryCharacter::TouchUpdate);
		return true;
	}
